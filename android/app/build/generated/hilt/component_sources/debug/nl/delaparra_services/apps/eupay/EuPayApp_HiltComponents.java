...
import nl.delaparra_services.apps.eupay.di.AppModule;
import nl.delaparra_services.apps.eupay.ui.MainActivity_GeneratedInjector;
...
public final class EuPayApp_HiltComponents {
  private EuPayApp_HiltComponents() {
  }
  ...
  @Subcomponent(
      modules = {
          ...
          TopUpViewModel_HiltModules.KeyModule.class
      }
  )
  ...
  @Subcomponent(
      modules = {
          ...
          TopUpViewModel_HiltModules.BindsModule.class
      }
  )
  @ViewModelScoped
