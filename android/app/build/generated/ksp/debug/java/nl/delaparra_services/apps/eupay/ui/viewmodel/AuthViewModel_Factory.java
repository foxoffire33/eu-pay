...
public final class AuthViewModel_Factory implements Factory<AuthViewModel> {
  ...
  public AuthViewModel_Factory(Provider<AuthService> authServiceProvider,
      Provider<PasskeyService> passkeyServiceProvider, Provider<Gson> gsonProvider) {
  ...
  public AuthViewModel get() {
    return newInstance(authServiceProvider.get(), passkeyServiceProvider.get(), gsonProvider.get());
  }

  public static AuthViewModel_Factory create(Provider<AuthService> authServiceProvider,
      Provider<PasskeyService> passkeyServiceProvider, Provider<Gson> gsonProvider) {
    return new AuthViewModel_Factory(authServiceProvider, passkeyServiceProvider, gsonProvider);
  }

  public static AuthViewModel newInstance(AuthService authService, PasskeyService passkeyService,
      Gson gson) {
    return new AuthViewModel(authService, passkeyService, gson);
  }
}
