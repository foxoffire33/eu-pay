...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\DigitalEuroController' => 'getDigitalEuroControllerService',
            'App\\Controller\\GdprController' => 'getGdprControllerService',
            'App\\Controller\\HceController' => 'getHceControllerService',
            'App\\Controller\\P2PController' => 'getP2PControllerService',
            'App\\Controller\\TopUpController' => 'getTopUpControllerService',
            'App\\Controller\\WebAuthnController' => 'getWebAuthnControllerService',
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $a->allowControllers(['App\\Kernel', 'App\\Controller\\AccountController', 'App\\Controller\\AuthController', 'App\\Controller\\CardController', 'App\\Controller\\DigitalEuroController', 'App\\Controller\\GdprController', 'App\\Controller\\HceController', 'App\\Controller\\P2PController', 'App\\Controller\\TopUpController', 'App\\Controller\\WebAuthnController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    /**
     * Gets the private '.service_locator._AVc6a9' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected static function get_ServiceLocator_AVc6a9Service($container)
    {
        $instance = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'security.firewall.map.context.webhook' => ['privates', 'security.firewall.map.context.webhook', 'getSecurity_Firewall_Map_Context_WebhookService', true],
            'security.firewall.map.context.passkey' => ['privates', 'security.firewall.map.context.passkey', 'getSecurity_Firewall_Map_Context_PasskeyService', true],
            'security.firewall.map.context.well_known' => ['privates', 'security.firewall.map.context.well_known', 'getSecurity_Firewall_Map_Context_WellKnownService', true],
            ...
            'security.firewall.map.context.webhook' => '?',
            'security.firewall.map.context.passkey' => '?',
            'security.firewall.map.context.well_known' => '?',
            'security.firewall.map.context.api' => '?',
        ]);

        if (isset($container->privates['.service_locator._AVc6a9'])) {
            return $container->privates['.service_locator._AVc6a9'];
        }

        return $container->privates['.service_locator._AVc6a9'] = $instance;
    }
    ...
    {
        $a = ($container->privates['.service_locator._AVc6a9'] ?? self::get_ServiceLocator_AVc6a9Service($container));
        ...
        $instance = new \Symfony\Bundle\SecurityBundle\Debug\TraceableFirewallListener(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($a, new RewindableGenerator(function () use ($container) {
            ...
            yield 'security.firewall.map.context.webhook' => ($container->privates['.security.request_matcher.0P0xFu2'] ?? $container->load('get_Security_RequestMatcher_0P0xFu2Service'));
            yield 'security.firewall.map.context.passkey' => ($container->privates['.security.request_matcher.vIcbCpp'] ?? $container->load('get_Security_RequestMatcher_VIcbCppService'));
            yield 'security.firewall.map.context.well_known' => ($container->privates['.security.request_matcher.n9zXlrz'] ?? $container->load('get_Security_RequestMatcher_N9zXlrzService'));
        ...
        }, 5)), $b, new \Symfony\Component\Security\Http\Logout\LogoutUrlGenerator(($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), ($container->services['router'] ?? self::getRouterService($container)), ($container->services['security.token_storage'] ??= new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage())));
    ...
    protected static function getDoctrine_Orm_DefaultConfigurationService($container)
    {
        ...
        $instance->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'App\\Repository\\HceTokenRepository' => ['privates', 'App\\Repository\\HceTokenRepository', 'getHceTokenRepositoryService', true],
            'App\\Repository\\P2PTransferRepository' => ['privates', 'App\\Repository\\P2PTransferRepository', 'getP2PTransferRepositoryService', true],
            'App\\Repository\\TopUpRepository' => ['privates', 'App\\Repository\\TopUpRepository', 'getTopUpRepositoryService', true],
            ...
            'App\\Repository\\WebAuthnCredentialRepository' => ['privates', 'App\\Repository\\WebAuthnCredentialRepository', 'getWebAuthnCredentialRepositoryService', true],
        ], [
            'App\\Repository\\CardRepository' => '?',
            'App\\Repository\\HceTokenRepository' => '?',
            'App\\Repository\\P2PTransferRepository' => '?',
            'App\\Repository\\TopUpRepository' => '?',
    ...
    private $loadedDynamicParameters = [
        ...
        'psd2_webhook_secret' => false,
        'card_encryption_key' => false,
        'hce_session_key_ttl' => false,
        'blind_index_key' => false,
        'webauthn_rp_id' => false,
        'webauthn_rp_name' => false,
        'kernel.secret' => false,
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'psd2_webhook_secret' => $container->getEnv('PSD2_WEBHOOK_SECRET'),
            'card_encryption_key' => $container->getEnv('CARD_ENCRYPTION_KEY'),
            'hce_session_key_ttl' => $container->getEnv('int:HCE_SESSION_KEY_TTL'),
            'blind_index_key' => $container->getEnv('BLIND_INDEX_KEY'),
            'webauthn_rp_id' => $container->getEnv('WEBAUTHN_RP_ID'),
            'webauthn_rp_name' => $container->getEnv('WEBAUTHN_RP_NAME'),
            ...
            'lexik_jwt_authentication.token_ttl' => $container->getEnv('int:JWT_TOKEN_TTL'),
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'nelmio_cors.map' => [
                ...
                '^/webhook/' => [
                    'allow_origin' => [
                        0 => 'https://api-sandbox.rabobank.nl',
                        1 => 'https://api.rabobank.nl',
                    ],
                    'allow_methods' => [
                        0 => 'POST',
                    ],
